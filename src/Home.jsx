    ...
    return (
        <>
            <div id="home">
                <div className="title-container">
                    ...
                    <p
                        ...
                        style={{ width: "30rem" }}
                    >
                        I'm a software engineer and graduate student at Seattle
                        University pursuing a Master's in Computer Science. I
                        previously earned my Bachelor's degree from the
                        University of Washington, where I focused on software
                    ...
                    <p
                        ...
                        style={{ width: "30rem" }}
                    >
                        I've gained hands-on experience through internships at
                        Bilimetrix and Hawl Technologies, where I worked on
                        backend integrations, frontend state management, and
                        AI-driven product features. My projects span from
                        evolutionary AI simulations using the NEAT algorithm to
                        full-stack web applications and research in AI modeling.
                    </p>
                    ...
                    <p
                        ...
                        style={{ width: "30rem" }}
                    >
                        I'm passionate about building reliable, user-focused
                        software, whether that means optimizing backend systems,
                        improving UI performance, or exploring new approaches to
                        applied AI. I thrive in collaborative environments,
                        value clean and maintainable code, and enjoy tackling
                    ...
                    <p
                        ...
                        style={{ width: "30rem" }}
                    >
                        Feel free to explore my projects and connect with me on
                        LinkedIn or GitHub!
                    </p>
                </div>
            ...
            <div className="tech-container">
                <p className="justify-content-start fs-2">
                    <br /> Technology
                </p>
                <p className="fs-5">
                    Here are the tools I have experience with.
                </p>
